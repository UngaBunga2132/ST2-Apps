...
# --- Additional Challenge Combinations ---

# Adding the missing combinations for Task 4
# (Insertion + Linear, Bubble + Linear, Bubble + Binary)

def insertion_linear(array, target):
    sorted_array = insertion_sort(array.copy())
    return linear_search(sorted_array, target)
...
# Measure runtimes
insertion_linear_time = timeit.timeit(lambda: insertion_linear(unsorted_list, target), number=1)
bubble_linear_time = timeit.timeit(lambda: bubble_linear(unsorted_list, target), number=1)
bubble_binary_time = timeit.timeit(lambda: bubble_binary(unsorted_list, target), number=1)

print(f"Linear Search (With Insertion Sorting): {insertion_linear_time:.6f} seconds")
print(f"Linear Search (With Bubble Sorting): {bubble_linear_time:.6f} seconds")
print(f"Binary Search (With Bubble Sorting): {bubble_binary_time:.6f} seconds")
